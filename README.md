...
Tetris written in 256 bytes or less. Currently it is at 247 bytes; complete with rotation, collision, all different tetraminos, lines being removed and dropping pieces.
